...
export function DashboardSidebar({
  ...
  const collapsed = mobile || !collapsible ? false : collapsedState;
  ...
  const secondaryMatch = showTemplateExtras && secondaryLabels.some(matches);
    ...
    >
      ...
      >
        ...
        >
          ...
          >
            {profile ?? (workspaceLabel ? <span className="text-body-medium whitespace-nowrap">{collapsed ? workspaceLabel.slice(0, 2) : workspaceLabel}</span> : <DashboardUserMenu
              collapsed={collapsed}
      ...
      <div className="flex w-full shrink-0 flex-col gap-3">
        ...
        <nav className="flex w-full flex-col gap-1">
          {showTemplateExtras && matches("Support") && (
            <NavItem icon={RiCustomerServiceLine} label="Support" collapsed={collapsed} />
          )}
          {showTemplateExtras && matches("Settings") && (
            <NavItem
        ...
        {showTemplateExtras && <DashboardTeamMenu
          collapsed={collapsed}
          className={flat ? "!bg-background-secondary-default" : undefined}
        />}
      </div>
